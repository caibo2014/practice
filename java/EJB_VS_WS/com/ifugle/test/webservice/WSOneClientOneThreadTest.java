 ...
 * 
 */
public class WSOneClientOneThreadTest {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < countArray.length; i++) {
			testMultiTimes(xml, service, countArray[i], port);
			System.out.println("-------------------------------------");
		}
	}

	private static void testMultiTimes(String xml, Gt3AipWebService_Service service, int count, Gt3AipWebService port) {
